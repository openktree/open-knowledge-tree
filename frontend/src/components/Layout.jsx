        ...
        <div class="absolute right-0 mt-2 w-64 bg-surface border border-border rounded-md shadow-lg z-20 overflow-hidden">
          ...
          <ul class="max-h-72 overflow-y-auto py-1">
            <For
              each={repositories()}
              fallback={
                <li class="px-3 py-3 text-sm text-text-muted">
...
export default function Layout(props) {
  ...
  const [collapsed, setCollapsed] = createSignal(
    localStorage.getItem("navbar_collapsed") === "1"
  );
  ...
  const showProviders = () => rbac.hasPermission("source_provider", "read") || rbac.hasPermission("ai_provider", "read");
  ...
  const navIcon = {
    ...
    "/sources": "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z",
    ...
    "/concepts": "M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.984 1.984 0 013 12V7a4 4 0 014-4z",
    "/reports": "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
    "/providers": "M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4",
    "/remote": "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9",
    "/users": "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
    "/tasks": "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4",
    "/ai-usage": "M13 10V3L4 14h7v7l9-11h-7z",
    "/repositories": "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m7 0V5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
  };
  ...
  const SectionHeader = (props) => (
    <Show
      when={!collapsed()}
      fallback={<div class="pt-4 pb-1 mx-3 border-t border-border" />}
    >
  ...
  const showSettings = () => rbac.hasPermission("repository", "write") || rbac.hasPermission("repository", "update");

  return (
    <div class="h-screen bg-page transition-colors flex overflow-hidden">
      <aside class="bg-surface border-r border-border flex-shrink-0 transition-all duration-200 flex flex-col h-full" classList={{ "w-56": !collapsed(), "w-16": collapsed() }}>
        <div class="px-3 py-3 border-b border-border flex-shrink-0 flex items-center" classList={{ "justify-end": collapsed(), "justify-between": !collapsed() }}>
          <Show when={!collapsed()}>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform duration-200" classList={{ "rotate-180": collapsed() }} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M11 19l-7-7 7-7m8 14l-7-7 7-7" />
            </svg>
          </button>
        </div>
        <nav class="flex flex-col p-2 gap-1 overflow-y-auto flex-1 min-h-0" classList={{ "p-3": !collapsed() }}>
      ...
      <div class="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        <header class="bg-surface border-b border-border transition-colors flex-shrink-0">
          <div class="px-6 py-3 flex items-center justify-end gap-4">
            ...
            <button
              ...
              class="text-sm text-danger hover:opacity-80 font-medium"
            >
              Sign Out
            </button>
          </div>
        ...
        <main class={`flex-1 w-full mx-auto px-6 py-8 overflow-y-auto ${props.maxWidth || "max-w-6xl"}`}>
          {props.children}
        </main>
      </div>
    </div>
