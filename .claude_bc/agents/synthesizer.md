...
tools: mcp__okt__*, Read, Write, Grep, Glob, WebFetch, TodoWrite
---
...
15. Check: Have you explored opposing perspectives as thoroughly as supporting
ones?
16. Have you traced paths between the most distant clusters via
`getRelatedConcepts`?
17. Only NOW write your complete document as your final response.
18. **MANDATORY (if a file path was given in your task prompt):** Write your
