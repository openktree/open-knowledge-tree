...
| 3 — 5 failure-mode audits | done | `results/failure_audits.json` |
| 4 — KGQA head-to-head | done (n=500 sample) | `exp4_kgqa/results/kgqa_headtohead.json` |
| REPORT.md | in progress (Exp 1-4 written) | — |